...
impl Scene {
    ...
    pub fn new() -> Self {
        ...
        res.render_engine = Option::from(Engine::new(
    ...
    pub(crate) fn get_render_tris(&self) -> Vec<(Vec<f32>, Vec<u32>)> {
        //! ## Returns
    ...
    pub fn render(&mut self) -> Result<RenderOutput, Error> {
        ...
        let mut engine = Engine::new(rc, RenderEngine::Raytracer);

        let output = engine.render(self.build_render_config());
        match output {
    ...
    pub(crate) fn build_render_config(&mut self) -> RenderConfig {
        self.update_render_builder();
        self.render_config_builder.clone().build()
    }
    pub(crate) fn update_render_builder(&mut self) {
        ...
        let rcb = if self.get_first_render() {
        ...
        self.render_config_builder = rcb;
    }
}
